...
//                 detailProdukKualitasStandar: detailProdukKualitasStandar.deskripsi, 
...
//         try {
//             const response = await axios.post(`http://localhost:7000/api/kualitas_standar/upload_image/${id}`, formData, {
//                 headers: {
//                     "Authorization": `Bearer ${localStorage.getItem("token")}`,
...
//                                 <p className="text-gray-700 w-2/3">{data.detailProdukKualitasStandar}</p>
//                             </div>
//                         </div>  
//                     </div>  
...
// export default UploadImageTkdn;