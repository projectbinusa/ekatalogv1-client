...
const ListByMonitor = () => {
    ...
    if (token) {
        axios.get("http://localhost:7000/api/list_produk/kualitas_standar/Monitor", {
        headers: {
        ...
        axios.get("http://localhost:7000/api/list_produk/kualitas_tinggi/Monitor", {
            headers: {
            Authorization: `Bearer ${token}`
            }
        })
