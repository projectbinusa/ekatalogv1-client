...
const ListByLaptop = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      axios.get("http://localhost:7000/api/list_produk/kualitas_standar/Laptop", {
        headers: {
      ...
      .then(responseStandar => {
        ...
        axios.get("http://localhost:7000/api/list_produk/kualitas_tinggi/Laptop", {
          headers: {
            Authorization: `Bearer ${token}`
          }
        })
