...
const ListByKeyboard = () => {
    ...
    useEffect(() => {
      ...
      if (token) {
        axios.get("http://localhost:7000/api/list_produk/kualitas_standar/Keyboard", {
          headers: {
        ...
        .then(responseStandar => {
          ...
          axios.get("http://localhost:7000/api/list_produk/kualitas_tinggi/Keyboard", {
            headers: {
              Authorization: `Bearer ${token}`
            }
          })
