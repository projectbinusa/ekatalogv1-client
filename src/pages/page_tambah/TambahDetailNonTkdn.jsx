...
const TambahDetailNonTkdn = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:7000/api/detail_produk/add/kualitas_tinggi", {
                method: "POST",
                headers: {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen">
            ...
            <div className="content-page max-h-screen container p-8 min-h-screen">
                <h1 className="judul text-3xl fonst semibold">Tambah Detail Kualitas Tinggi</h1>
                <div
...
export default TambahDetailNonTkdn;